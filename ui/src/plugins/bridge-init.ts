 ...
 *
 * This is placed on `globalThis.__nexioPluginBridge__` and consumed by
...
declare global {
  ...
  var __nexioPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__nexioPluginBridge__` so the plugin module loader
...
export function initPluginBridge(
  ...
  globalThis.__nexioPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
