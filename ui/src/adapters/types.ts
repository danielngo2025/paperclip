...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@nexioai/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@nexioai/adapter-utils").TranscriptEntry[];
