...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within NexioPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the Nexio host.
 *
...
export interface NexioPluginManifestV1 {
   ...
   */
  minimumNexioVersion?: PluginMinimumHostVersion;
