/**
 * `@nexioai/plugin-sdk/ui` — Nexio plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@nexioai/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@nexioai/plugin-sdk/ui";
 *
