...
import type { NexioPlugin } from "./define-plugin.js";
import type {
 ...
 * import { startWorkerRpcHost } from "@nexioai/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  let manifest: NexioPluginManifestV1 | null = null;
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@nexioai/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
