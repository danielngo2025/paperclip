/**
 * `definePlugin` — the top-level helper for authoring a Nexio plugin.
 *
...
// ---------------------------------------------------------------------------
// NexioPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `NexioPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@nexioai/plugin-sdk";
