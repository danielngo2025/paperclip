...
const manifest: NexioPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Nexio plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Nexio",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Nexio domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
