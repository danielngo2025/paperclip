...
import { models as codexFallbackModels } from "@nexioai/adapter-codex-local";
import { models as cursorFallbackModels } from "@nexioai/adapter-cursor-local";
import { resetOpenCodeModelsCacheForTests } from "@nexioai/adapter-opencode-local/server";
...
describe("adapter model listing", () => {
  beforeEach(() => {
    ...
    delete process.env.NEXIO_OPENCODE_COMMAND;
  ...
  it("returns no opencode models when opencode command is unavailable", async () => {
    process.env.NEXIO_OPENCODE_COMMAND = "__nexio_missing_opencode_command__";
