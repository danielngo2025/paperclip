...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@nexioai/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: NexioPluginManifestV1, pluginDbId?: string): void;
