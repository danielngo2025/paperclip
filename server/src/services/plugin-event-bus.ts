/**
 * PluginEventBus — typed in-process event bus for the Nexio plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@nexioai/shared";
import type { PluginEvent, EventFilter } from "@nexioai/plugin-sdk";
