...
This is intentionally separate from the normal Nexio dev image.
...
```sh
review-checkout-pr danielngo2025/Nexio 432
cd /work/checkouts/nexioai-nexio/pr-432
```
...
## Preview the Nexio app from the PR
...
- Nexio's embedded PostgreSQL and local storage stay inside the container home volume via `NEXIO_HOME=/home/reviewer/.nexio-review`.
