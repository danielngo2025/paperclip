...
- `skills/nexio/SKILL.md` and `skills/nexio/references/api-reference.md` do not currently require markdown formatting quality for status comments (links, structure, readable updates).
...
## 6.2 `skills/nexio-create-agent/SKILL.md`
