...
- installed adapter list for this Nexio instance
...
## 8. New Skill: `nexio-create-agent`

Create new skill directory:

- `skills/nexio-create-agent/SKILL.md`
...
Also update `skills/nexio/SKILL.md` to reference this skill for hiring workflows.
...
- `nexio-create-agent` skill + docs updates
