...
- Primary: PostgreSQL
- Local default: embedded PostgreSQL at `~/.nexio/instances/default/db`
- Optional local prod-like: Docker Postgres
- Optional hosted: Supabase/Postgres-compatible
- File/object storage:
  - local default: `~/.nexio/instances/default/data/storage` (`local_disk`)
...
- exactly one JSON entrypoint: `nexio.manifest.json`
