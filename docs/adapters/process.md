...
- Running a Python script that calls the Nexio API
...
1. Nexio spawns the configured command as a child process
2. Standard Nexio environment variables are injected (`NEXIO_AGENT_ID`, `NEXIO_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Nexio API and perform work.
