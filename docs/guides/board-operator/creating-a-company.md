...
A company is the top-level unit in Nexio. Everything — agents, tasks, goals, budgets — lives under a company.
...
Set monthly budgets at both the company and per-agent level. Nexio enforces:
